...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        try {
            ...
            System.err.println("Quiz image not found.");
        }
        ...
        questions[9][1] = "Bytecode is executed by JVM"; questions[9][2] = "The applet makes the Java code secure"; questions[9][3] = "Use of exception handling"; questions[9][4] = "Dynamic binding";
        
        answers[0][1] = "JDB"; answers[1][1] = "int"; answers[2][1] = "java.util package"; answers[3][1] = "Marker Interface"; answers[4][1] = "Heap memory";
        answers[5][1] = "Remote interface"; answers[6][1] = "import"; answers[7][1] = "Java Archive"; answers[8][1] = "java.lang.StringBuilder"; answers[9][1] = "Bytecode is executed by JVM";
        
        opt1 = new JRadioButton(); opt1.setBounds(170, 520, 700, 30); opt1.setBackground(Color.WHITE); opt1.setFont(new Font("Dialog", Font.PLAIN, 20)); add(opt1);
        opt2 = new JRadioButton(); opt2.setBounds(170, 560, 700, 30); opt2.setBackground(Color.WHITE); opt2.setFont(new Font("Dialog", Font.PLAIN, 20)); add(opt2);
        opt3 = new JRadioButton(); opt3.setBounds(170, 600, 700, 30); opt3.setBackground(Color.WHITE); opt3.setFont(new Font("Dialog", Font.PLAIN, 20)); add(opt3);
        opt4 = new JRadioButton(); opt4.setBounds(170, 640, 700, 30); opt4.setBackground(Color.WHITE); opt4.setFont(new Font("Dialog", Font.PLAIN, 20)); add(opt4);
        
        groupoptions = new ButtonGroup();
        groupoptions.add(opt1); groupoptions.add(opt2); groupoptions.add(opt3); groupoptions.add(opt4);
        
        // --- BUTTONS WITH ADJUSTED BOUNDS ---
        ...
        back.setBounds(1100, 540, 200, 40);
    ...
    private void handleLifeline() {
        if (count == 2 || count == 4 || count == 6 || count == 8 || count == 9) {
            opt2.setEnabled(false); opt3.setEnabled(false);
        } else {
            opt1.setEnabled(false); opt4.setEnabled(false);
        }
    ...
    public void start(int count) {
        ...
        // --- THE "MEMORY" LOGIC ---
        // Check if we have a saved answer for this question and re-select it
        if (useranswers[count][0] != null && !useranswers[count][0].equals("")) {
            String savedAns = useranswers[count][0];
            if (opt1.getActionCommand().equals(savedAns)) opt1.setSelected(true);
            else if (opt2.getActionCommand().equals(savedAns)) opt2.setSelected(true);
            else if (opt3.getActionCommand().equals(savedAns)) opt3.setSelected(true);
            else if (opt4.getActionCommand().equals(savedAns)) opt4.setSelected(true);
        }
